...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', '-i', default='./test.png',help='path to image')
    parser.add_argument('--model', '-m',default='./weight/pretrain.pth.tar', help='path to model')
    parser.add_argument('--word_map', '-wm', default='./data/fullhand/vocab.json',help='path to word map JSON')
